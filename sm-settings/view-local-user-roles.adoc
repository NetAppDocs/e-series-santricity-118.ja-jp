...
summary: '[ローカルユーザーの役割]タブでは、ユーザープロファイルとデフォルトの役割のマッピングを表示できます。これらのマッピングは、ストレージアレイに適用されるロールベースアクセス制御（RBAC）の一部です。' 
---
= ローカルユーザロールの表示
:allow-uri-read: 
:experimental: 
...
[role="lead"]
[ローカルユーザーの役割]タブでは、ユーザープロファイルとデフォルトの役割のマッピングを表示できます。これらのマッピングは、ストレージアレイに適用されるロールベースアクセス制御（RBAC）の一部です。
...
** *Monitor*(モニタ)--システムへの読み取り専用アクセス権を持つユーザ。このユーザプロファイルにはMonitorロールのみが含まれています。
